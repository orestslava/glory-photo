...
function MainPageSwiper() {
    ...
    return (
        ...
        >
          <SwiperSlide className="h-full w-full bg-center bg-no-repeat bg-cover bg-[url('assets/images/main-page-full-screen-1.jpg')]"/>
          <SwiperSlide className="h-full w-full bg-center bg-no-repeat bg-cover bg-[url('assets/images/main-page-full-screen-2.jpg')]"/>
          <SwiperSlide className="h-full w-full bg-center bg-no-repeat bg-cover bg-[url('assets/images/main-page-full-screen-3.jpg')]"/>
          <SwiperSlide className="h-full w-full bg-center bg-no-repeat bg-cover bg-[url('assets/images/main-page-full-screen-4.jpg')]"/>
          <SwiperSlide className="h-full w-full bg-center bg-no-repeat bg-cover bg-[url('assets/images/main-page-full-screen-5.jpg')]"/>
          <SwiperSlide className="h-full w-full bg-center bg-no-repeat bg-cover bg-[url('assets/images/main-page-full-screen-6.jpg')]"/>
        </Swiper>
        <div className='w-full absolute bottom-0 z-50 px-10'>
            <div className='flex justify-center items-center max-w-[1200px] mx-auto border-t border-white py-5'>
